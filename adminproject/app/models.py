...
class Sala(models.Model):
    nome = models.CharField(max_length=80, null=False, blank=False, verbose_name="Nome :")
...
class Armario(models.Model):
    ...
    sigla = models.CharField(max_length=50, null=True, verbose_name="SIGLA :")
    tombo = models.CharField(max_length=50, primary_key=True, null=False, blank=False, verbose_name="Tombo:" )
    sala_armario = models.ForeignKey(Sala, on_delete=models.CASCADE, null=False, related_name='Sala_armario')
    obs = models.TextField(verbose_name="Observação", null=True, blank=True)
...
class Prateleira(models.Model):
    nome = models.CharField(max_length=50, null=False, verbose_name="Nome :")
    sigla = models.CharField(max_length=50, null=True, verbose_name="SIGLA :")
    armario_prateleira = models.ForeignKey(Armario, on_delete=models.PROTECT, null=True, related_name='Armario_Prateleira')
    bancada_prateleira = models.ForeignKey(Bancada, on_delete=models.PROTECT, null=True, related_name='Bancada_Prateleira')
    estante_prateleira = models.ForeignKey(Estante, on_delete=models.PROTECT, null=True, related_name='Estante_prateleira')
...
class Gaveta(models.Model):
    nome = models.CharField(max_length=50, null=False, verbose_name="Nome :")
    sigla = models.CharField(max_length=50, null=True, verbose_name="SIGLA :")
    armario_gaveta = models.ForeignKey(Armario, on_delete=models.PROTECT, null=True, related_name='Armario_gaveta')
...
class Diverso(models.Model):
    ...
    ficha_tec = models.ImageField(upload_to='images',null=True, verbose_name="Ficha Técnica :")
    especficacao_t = models.TextField(null=True, verbose_name="Especificação Técnica")
    obs = models.TextField(verbose_name="Observação")
    sala_diversos = models.ForeignKey(Sala, on_delete=models.PROTECT, null=True, related_name='Sala_Diversos')
    armario_diversos = models.ForeignKey(Armario, on_delete=models.PROTECT, null=True, related_name='Armario_Diversos')
    bancada_diversos = models.ForeignKey(Bancada, on_delete=models.PROTECT, null=True, related_name='Bancada_Diversos')
    estante_diversos = models.ForeignKey(Estante, on_delete=models.PROTECT, null=True, related_name='Estante_Diversos')
    gaveta_diversos = models.ForeignKey(Gaveta, on_delete=models.PROTECT, null=True, related_name='Gaveta_Diversos')
...
class Equipamento(models.Model):
    ...
    armario_equipamentos = models.ForeignKey(Armario, on_delete=models.PROTECT, null=True, related_name='Armario_Equipamentos')
    bancada_equipamentos = models.ForeignKey(Bancada, on_delete=models.PROTECT, null=True, related_name='Bancada_Equipamentos')
    estante_equipamentos = models.ForeignKey(Estante, on_delete=models.PROTECT, null=True, related_name='Estante_Equipamentos')
    gaveta_equipamentos = models.ForeignKey(Gaveta, on_delete=models.PROTECT, null=True, related_name='Gaveta_Equipamentos')
...
class Vidraria(models.Model):
    ...
    especficacao_t = models.TextField( verbose_name="Especificação Técnica")
    obs = models.TextField(verbose_name="Observação")
    sala_vidraria = models.ForeignKey(Sala, on_delete=models.PROTECT, null=True, related_name='Sala_Vidraria')
    armario_vidraria = models.ForeignKey(Armario, on_delete=models.PROTECT, null=True, related_name='Armario_Vidraria')
    bancada_vidraria = models.ForeignKey(Bancada, on_delete=models.PROTECT, null=True, related_name='Bancada_Vidraria')
    estante_vidraria = models.ForeignKey(Estante, on_delete=models.PROTECT, null=True, related_name='Estante_Vidraria')
    gaveta_vidraria = models.ForeignKey(Gaveta, on_delete=models.PROTECT, null=True, related_name='Gaveta_Vidraria')
